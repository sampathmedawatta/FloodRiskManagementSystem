              ...
              <div className="row">
                <div className="col-md-7">
                  <h6 className="text-start">
                    <i className="bi bi-tsunami fs-5" />&nbsp;Weekly Flood Forecast
                  </h6>
                </div>
                  ...
                  <div className="col-6">
                    <div className="card-style-1 hover-up risklevel-high">
                      <div className="card-info">
                        ...
                        <p className="text-10 text-center strong color-brand-1">Life threatening situations</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-6">
                    <div className="card-style-1 hover-up risklevel-moderate">
                      <div className="card-info">
                        ...
                        <p className="text-10 text-center strong color-brand-1">Flood Expected: Take Immediate Action</p>
                      </div>
                    </div>
                  </div>
                </div>
