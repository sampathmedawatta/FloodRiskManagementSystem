...
const EmergencyContactCardHolder = () => {
  ...
  useEffect(() => {
    const loadEmergencyContacts = async () => {
      try {
        ...
        const groupedContacts = groupContactsByType(refLocations);
  ...
  const groupContactsByType = (refLocations) => {

    const groupedContacts = {};
    refLocations.forEach((loc) => {
      if (!groupedContacts[loc.type]) {
        groupedContacts[loc.type] = [];
      }
      groupedContacts[loc.type].push(loc);
    });
            ...
            <div className="panel-white">
              ...
              <div className="panel-body">
                <div className="accordion" id="contactAccordion">
                  {emergencyContacts !== null && Object
                    .keys(emergencyContacts)
                    .map((type, index) => (
